          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4 mb-8 text-sm md:text-base text-[var(--color-text-muted)]">
              ...
              <li className="flex items-start gap-3">
                ...
                <span>GSTIN: 05APTPH1635N1ZG</span>
              </li>
            </ul>
            ...
            <div className="mt-8 flex gap-4">
              <a href="https://instagram.com/siphorahq" target="_blank" rel="noopener noreferrer" className="text-[var(--color-primary)] hover:opacity-75 transition-opacity">
