      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          ...
          <div className="col-span-1">
            <h2 className="text-[var(--color-primary)] text-lg font-serif mb-6">Quick links</h2>
            <ul className="space-y-4">
              <li><Link href="/" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors text-sm">Home</Link></li>
              <li><Link href="/products" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors text-sm">Shop All</Link></li>
              ...
              <li><Link href="/products" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors text-sm">Decorative Items</Link></li>
            </ul>
          </div>

          {/* Column 2: Info */}
          <div className="col-span-1">
            <h2 className="text-[var(--color-primary)] text-lg font-serif mb-6">Info</h2>
            <ul className="space-y-4">
              <li><Link href="/about" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors text-sm">About Us</Link></li>
              ...
              <li><Link href="/track-order" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors text-sm">Track Order</Link></li>
          ...
          {/* Column 3: Policies */}
          <div className="col-span-1">
            <h2 className="text-[var(--color-primary)] text-lg font-serif mb-6">Policies</h2>
            <ul className="space-y-4">
              ...
              <li><Link href="/refund-policy" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors text-sm">Refund Policy</Link></li>
              ...
              <li><Link href="/terms-of-service" className="text-[var(--color-text-muted)] hover:text-[var(--color-primary)] transition-colors text-sm">Terms of Service</Link></li>
            </ul>
          </div>

          {/* Column 4: Newsletter */}
          <div className="col-span-1 md:col-span-1">
            <h2 className="text-[var(--color-primary)] text-lg font-serif mb-6">Subscribe to our emails</h2>
            <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
              <div className="relative">
                <input 
                  type="email" 
                  placeholder="Email" 
                  className="w-full bg-transparent border border-[var(--color-border)] text-[var(--color-primary)] px-4 py-3 pr-12 focus:outline-none focus:border-[var(--color-primary)] transition-colors rounded-sm"
                  required
                />
                <button 
                  type="submit" 
                  className="absolute right-0 top-0 bottom-0 px-4 text-[var(--color-primary)] hover:text-[var(--color-secondary)] transition-colors"
