  ...
  return (
    <div className="max-w-4xl mx-auto py-20 px-4 min-h-[50vh]">
      ...
      <div className="text-[var(--color-text-muted)] leading-relaxed text-lg">
        <p className="mb-6 font-medium">Luxury You Can Trust</p>
        <ul className="list-disc pl-6 my-4 space-y-3">
          <li>Premium Porcelain Collections</li>
          <li>Elegant Gift-Worthy Packaging</li>
          <li>Carefully Curated Designs</li>
          <li>Secure Payments</li>
          <li>Fast Nationwide Delivery</li>
          <li>Dedicated Customer Support</li>
          <li>Trusted Quality Standards</li>
        </ul>
      </div>
    </div>
  );
