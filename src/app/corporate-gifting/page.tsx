    ...
    <div className="min-h-screen bg-[var(--color-bg)] py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-lg mx-auto text-[var(--color-text-muted)] font-sans whitespace-pre-wrap leading-relaxed">
          Elevate your corporate relationships with Siphorahq. We offer bulk pricing, custom branding, and specialized packaging for corporate clients. Contact support@siphorahq.in for a catalog.
        </div>
      </div>
    </div>
  );
